...
public class BoardControllerTest {
	...
	public void upload() throws Exception{
		MockMultipartFile file1 = new MockMultipartFile("fileList", "OFN01.txt",null,"first".getBytes());
		MockMultipartFile file2 = new MockMultipartFile("fileList", "OFN02.txt",null,"last".getBytes());
